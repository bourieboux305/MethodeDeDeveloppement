...
public abstract class Birds extends Panel {

	protected double birdX,birdY;//coordennée x et y
	...
	public void crashGround(Environement env){
		if(birdX < 20 || birdX > 780 || birdY < 0 || birdY > env.getHauteurGround()-20)
			stop=true;
	}
